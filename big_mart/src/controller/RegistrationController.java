...
public class RegistrationController {
    ...
    class RegistrationListener implements ActionListener
    {
        ...
        public boolean checkUser(RegistrationModel user) throws Exception
        {
            ...
            String sql = "insert into bigmart'username="+user.getUsername()+"' AND password='"+user.getPassword()+"' AND fname='"+user.getFname()+"' AND lname='"+user.getLname()+"' And email='"+user.getEmail()+"' AND gender='"+user.getGender()+"' AND role='"+user.getRole()+"'";
            try
            {
